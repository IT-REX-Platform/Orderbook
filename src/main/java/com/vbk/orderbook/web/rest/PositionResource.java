...
import com.vbk.orderbook.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.vbk.orderbook.domain.Position}.
 */
@RestController
@RequestMapping("/api")
public class PositionResource {
    ...
    private static final String ENTITY_NAME = "orderbookPosition";
