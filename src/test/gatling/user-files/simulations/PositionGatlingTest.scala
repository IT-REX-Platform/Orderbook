...
class PositionGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Position entity")
        ...
        .repeat(2) {
            ...
            .get("/services/orderbook/api/positions")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new position")
            .post("/services/orderbook/api/positions")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "asset":"SAMPLE_TEXT"
                , "buyAt":"2020-01-01T00:00:00.000Z"
                , "sellAt":"2020-01-01T00:00:00.000Z"
                , "entryValue":null
                , "exitValue":null
                , "operationType":"SHORT"
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/orderbook${new_position_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created position")
            .delete("/services/orderbook${new_position_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
